...
def fire_missiel(missiel_x,missiel_y):
	...
	if weapon_upgraded and fired_missiel:
		screen.blit(missiel_img_l[0],( missiel_x - 60,missiel_y))
		screen.blit(missiel_img_l[1],(missiel_x + 120,missiel_y))
...
if  game_over == False:
	...
	#====== LIFE LOST COLLISION======
		...
		# hit by left missiel
		missiel_1_on_target = int(math.sqrt((turtlex-missiel_x)**2 + (turtley - missiel_y)**2))
		#hit by right missiel
		missiel_2_on_target = int(math.sqrt((turtlex-missiel_x)**2 + (turtley-missiel_y)**2))
		...
		if weapon_upgraded:
			if fired_missiel:
				...
				missiel_x =  missiel_coordinate[0]
