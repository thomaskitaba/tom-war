...
total_enemies_distroyed_l = [turtle_shoot_l[0] + tank_missiel_shoot_l[0] +jet_shoot_l[0] + ufo_shoot_l[0] ]

total_enemies_missed_l = [turtle_missed_l[0] + tank_missiel_shoot_l[0] +jet_missed_l[0] + ufo_missed_l[0]]

total_enemies_l = [ total_enemies_distroyed_l[0] + total_enemies_missed_l[0]]
...
mini_missile = pygame.image.load("missile_1.png")
mini_ufo = pygame.image.load("ufo_1.png")
# SCALE IMAGES 
mini_turtle_l.append(pygame.transform.scale(mini_jet, (20,20)))
mini_missile_l.append(pygame.transform.scale(mini_missile, (20,20)))
mini_jet_l.append(pygame.transform.scale(mini_jet, (20,20)))
mini_ufo_l.append(pygame.transform.scale(mini_ufo, (20,20)))

game_data_font = pygame.font.SysFont("Comic Sans MS", 40)
# left title
lable_destroyed = game_data_font.render("Destroyed", 1,(255,0,0))
lable_missed = game_data_font.render("Missed", 1, (255,0,0))
...
screen.blit(mini_missile_l[0], (250,0))
screen.blit(mini_jet_l[0], (350,0))
screen.blit(mini_ufo_l[0], (450,0))

screen.blit(lable_destroyed, (10, 20))
screen.blit(lable_missed, (10, 40))
