...
life_bar_tank_start_x_l = [100]
life_bar_tank_start_y_l = [100]
life_bar_tank_end_x_l= [200]
life_bar_tank_end_y_l = [100]
life_bar_red_tank_end_x_l= [200]
...
# put the label object on the screen at point x=100, s
	...
	screen.blit(myscore,(660,0))
	screen.blit(lable_life, (0, 0))	
	screen.blit(mylife,(110,0))   
...
def show_game_data():
	...
	#### HIT - HIT - HIT
	screen.blit(turtle_shoot_r, (150,40))
	screen.blit(tank_missiel_shoot_r, (200,40))
	screen.blit(jet_shoot_r, (250,40))
	screen.blit(ufo_shoot_r, (300,40))
	
	### MISSED - MISSID -MISSED
	screen.blit(turtle_missed_r, (150,75))
	screen.blit(tank_missile_missed_r, (200,75))
	screen.blit(jet_missed_r, (250,75))
	screen.blit(ufo_missed_r, (300,75))
