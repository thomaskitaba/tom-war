...
#-------bush 1
bush_1_x= int(random.randint(0,300))
bush_1_y = int(random.randint(100,300))
#-------- tree-1
tree_1_x = int(random.randint(300,600))
tree_1_y = int(random.randint(100,300))
#-------bush 2
bush_2_x = int(random.randint(0,300))
bush_2_y = int(random.randint(100,300))
#-------- tree-2
tree_2_x  = int(random.randint(300,600))
tree_2_y = int(random.randint(100,300))
...
if  game_over == False:
	...
	# check collision for life lost
		...
		# record SCORE
			...
			if current_time - score_clock < 100:
				explode = True
